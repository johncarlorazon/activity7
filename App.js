...
import StudList from './src/StudList';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginBottom: 30 }}>
        <Button title="Add Student" onPress={addStudent} color="green"/>
      </View>
      <View style={{ marginBottom: 30 }}>
        <Button title="View" onPress={() => navigation.navigate('Student List')}color="green" />
      </View>
    </View>
  );
}

function StudLists({ navigation }) {
  const toast = useToast();
  ...
  return (
    <View style={{ backgroundColor: 'white' }}>
      <StudList />
      <View style={{ marginBottom: 30 }}>
        <Button title="Add Student" onPress={() => navigation.goBack()} color="green"/>
      </View>
      <View style={{ marginBottom: 30 }}>
...
function AddStudentPage() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Student List" component={StudLists} />
    </Stack.Navigator>
  );
}
